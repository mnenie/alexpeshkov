...
import type { CardWithoutDescription } from '~/types'

defineProps<{
  item: CardWithoutDescription
}>()
...
<template>
  ...
  >
    <div class="relative">
      <div
        class="w-full rounded-lg relative lg:h-[210px] card overflow-hidden"
      >
        <img
          class="rounded-lg lg:h-[210px] w-full card"
          :src="item.img"
        >
        <div
          v-if="item && item.site"
