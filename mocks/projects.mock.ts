export const projects = ref<Project[]>([
  {
    ...
    stack: '#nuxt3, #typescript, #pinia, #tailwind, #shadcn, #vitest, #yandex-gpt, #express, #mongodb', product: 'https://notium.vercel.app/', github: 'https://github.com/mnenie/notium'
  },
  {
    id: 2, img: '/projects/kugoo.png', title: 'Eccomerce for selling electric scooters Kugoo-Russia (freelance)',
    stack: '#vue3, #typescript, #pinia, #scss, #firebase, #stripe', product: 'https://kugoo-ffd41.web.app/', github: 'https://github.com/mnenie/Kugoo'
  },
  {
    id: 3, img: '/projects/agile.png', title: 'AgileFusion: developing an ideal agile system (work)',
  ...
  {
    id: 5, img: '/projects/ithub.jpeg', title: 'Service that includes the use of AI for college students onboarding',
    stack: '#nuxt3, #typescript, #pinia, #tailwind, #shadcn, #express, #mongodb, #yandex-gpt', github: 'https://github.com/mnenie/ithub-hack'
  },
  {
    id: 6, img: '/projects/prettier.png', title: 'My prettier config - @mnenie/prettier for (.js, .ts, .vue, .jsx, .tsx)',
  ...
  {
    id: 7, img: '/projects/vortex.png', title: 'Vortex Ui - ui kit for Vue 3 + Tailwind',
    stack: '#vue3, #typescript, #tailwind, #npm', github: 'https://github.com/mnenie/vortexui-vue'
  },
  {
    id: 8, img: '/projects/sovkombank.jpg', title: 'Automatic task allocation service for visiting sovkombank employees (work)',
  ...
  {
    id: 9, img: '/projects/teachers.png', title: 'The Teachers Portal is a multi-page website written in the Vue framework for finding tutors and students (freelance)',
